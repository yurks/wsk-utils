...
var quoteattr = require('./quoteattr');

var random = require('./random');

var window = require('./window');
var document = require('./document');//TODO: document.body
var location = require('./location');

var urlValidate = require('./url-validate');
...
var oldBrowserIframeRender = function() {
    ...
    return dom.render('<html><body></body></html>', oldBrowserIframeAttrs, 'iframe');
};
...
module.exports = function(url, callback, request_data, type, opts) {
    ...
    var onIframeCreated = function() {
        ...
        var form = dom.render(renderRequestData(context.request_data), {method: 'post', action: form_action}, 'form');
        dom.html(form, oldBrowserIframeGetTag(context.iframe));
    ...
    var request = function() {
        context.iframe = dom.create(oldBrowserIframeRender());
        event.on(context.iframe, 'load', onIframeCreated);
        dom.append(context.iframe, document.body);
